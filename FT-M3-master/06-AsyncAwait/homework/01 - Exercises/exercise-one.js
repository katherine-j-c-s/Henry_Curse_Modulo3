...
async function problemB() {
  ...
  // asyncawait version
  // Tu código acá:
  async function poems(stanzas){
    exerciseUtils.blue(await exerciseUtils.promisifiedReadFile(stanzas))
  }
  poems("poem-one/stanza-02.txt")
  poems("poem-one/stanza-03.txt")
}
